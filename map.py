...
game_map = {
    ...
    "enemies": {
        ...
        "moub3goblin": {
            "name": "goblin",
            "type": "goblin",
            "init_desc": "However, a goblin is blocking your way back.",
            "blocks": ["west"],
            "inventory": ["matchbook"],
            "death_text": [
                "Your last attack was too much for the goblin. It dies, immediately disappearing in a plume of black smoke. Left behind, in the snow, is a matchbook containing several matches.",
                "The goblin dies instantly. What a pussy. Its body disappears in a plume of black smoke. Left behind, in the snow, is a matchbook containing several matches."
            ]
        },
        "mouc2giant": {
            "name": "giant",
    ...
    "message": [
        "Wow! What a speed run! Have you played this before??",
        "That's a decent time! You're a natural!",
        "Nice job!"
    ],
    "credits": {
        "Creator": ["James Smith"],
